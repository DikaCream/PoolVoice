 ...
 */
export function createPoolVoiceClient(address?: string | null) {
...
export function isRightNetwork(chainId: string | null): boolean {
  return chainId != null && chainId.toLowerCase() === STUDIONET_CHAIN_ID_HEX.toLowerCase();
}

/** Ask the wallet to add/switch to GenLayer StudioNet. */
